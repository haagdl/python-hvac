...
evp = Evaporator(
    ...
    S_trv=Q_(20.0, 'mm'),         # vertical distance between tubes
    S_lon=Q_(17.0, 'mm'),         # horizontal distance between tubes
    D_int=Q_(6, 'mm'),        # inner tube diameter
    D_ext=Q_(8, 'mm'),         # outer tube diameter
    t_fin=Q_(0.2, 'mm'),       # fin thickness
    N_fin=1 / Q_(3.5, 'mm'),    # fin density
    k_fin=Q_(200, 'W / (m * K)')  # conductivity of fin material
)
